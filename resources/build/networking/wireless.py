...
class BuildWirelessNetworking:
    ...
    def _on_model(self) -> None:
        ...
        if isinstance(self.computer.wifi, device_probe.IntelWireless):
            if self.computer.wifi.chipset in [device_probe.IntelWireless.Chipsets.IntelWirelessNIC]:
                ...
                support.BuildSupport(self.model, self.constants, self.config).get_kext_by_bundle_path("IO80211FamilyLegacy.kext/Contents/PlugIns/AirPortBrcmNIC.kext")["Enabled"] = False
